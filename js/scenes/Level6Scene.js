var Level6Scene = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize:
  
      function Level6Scene() { Phaser.Scene.call(this, { key: 'level6scene' }); },
    ...
    create: function () {
      ...
      this.level6_music = this.sound.add("level1_theme");
      var musicConfig = {
        mute: 0,
        volume: 0.6,
        seek: 0,
      ...
      this.level6_music.play(musicConfig);
      ...
      this.time.addEvent({
        ...
        callback: function () {
          var mine1 = null;
          var mine2 = null;
          var yPos = Phaser.Math.Between(300, this.game.config.height - 300)
          ...
          if (mine1 !== null) this.mines.add(mine1);
          if (mine2 !== null) this.mines.add(mine2);
      ...
      this.add.text(31, 16, 'Level: 6', { fontSize: '72px', fill: '#ffffff', fontFamily: 'pixel_font' })
    ...
    update: function () {
      ...
      bgParallax1.tilePositionX += 5;
      bgParallax2.tilePositionX += 10;
    },
  ...
  checkTimeToSurvive() {
    ...
    YouLost() {
      if (!this.FadeActive) {
        ...
        this.physics.pause();
        this.level6_music.stop();
        this.player.setTint(0xff0000);
        this.cameras.main.fadeOut(500, 0, 0, 0);
        this.cameras.main.once(Phaser.Cameras.Scene2D.Events.FADE_OUT_COMPLETE, (cam, effect) => {
          this.scene.start('gameoverscene', { currentScene: 'level6scene'});
        });
      }
    },
    ...
    YouWon() {
      if (!this.FadeActive) {
        ...
        this.cameras.main.fadeOut(500, 0, 0, 0);
        this.cameras.main.once(Phaser.Cameras.Scene2D.Events.FADE_OUT_COMPLETE, (cam, effect) => {
          this.scene.start('victoryscene', { nextScene: 'level7scene'});
        });
      }
    },
